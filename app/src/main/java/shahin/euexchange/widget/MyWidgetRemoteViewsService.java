package shahin.euexchange.widget;
...
public class MyWidgetRemoteViewsService extends RemoteViewsService {
    ...
    class MyWidgetRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public void onDataSetChanged() {
            ...
            String json = preferences.getString(WIDGET_SHARED_PREFS_KEY, "");
            if (!json.equals("")) {
                Gson gson = new Gson();
        ...
        public RemoteViews getViewAt(int position) {
            ...
            rv.setTextViewText(R.id.widget_tv_name, myObjects.get(position).getWidgetString());
            return rv;
        }
